...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form method="POST" action="/faculty_staff/programme/{{$prog_id}}/remove_prog_courses">
                {{ csrf_field() }}
        ...
        <div class="col-md-6">
            ...
            <form method="POST" action="/faculty_staff/programme/{{$prog_id}}/add_prog_courses" enctype="multipart/form-data">
                {{ csrf_field() }}
