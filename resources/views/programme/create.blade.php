        ...
        <div class="col-md-6 mx-auto">
            ...
            <form method="POST" action="/programme/store" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('prog_name') }}" name="prog_name" id="prog_name" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="prog_duration" value="{{ old('prog_duration') }}"  id="prog_duration" class="form-control" min="1" max="4"
                        placeholder="Enter programme study duration (years)">
                </div>
                @error('prog_duration')
                <p class="text-danger font-weight-bold">{{ $message }}</p>
                @enderror
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="prog_level" id="prog_level">
                        <option value="Diploma" @if(old('prog_level') === "Diploma") {{'selected="selected"'}}@endif>Diploma</option>
                        <option value="Bachelor Degree" @if(old('prog_level') === "Bachelor Degree") {{'selected="selected"'}}@endif>Bachelor Degree</option>
                        <option value="Master" @if(old('prog_level') === "Master") {{'selected="selected"'}}@endif>Master</option>
                        <option value="Doctorate (PhD)" @if(old('prog_level') === "Doctorate (PhD)") {{'selected="selected"'}}@endif>Doctorate (PhD)</option>
                    </select>
                </div>
                @error('prog_level')
                <p class="text-danger font-weight-bold">{{ $message }}</p>
